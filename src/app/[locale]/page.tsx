          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                    {t.qualifications.aerialPhotography.title}
                  </h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    {t.qualifications.aerialPhotography.description}
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="contact" className="text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
            ...
            <div className="flex justify-center space-x-6">
              <a href="https://x.com/ukyokyongt" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
                <span>@ukyokyongt</span>
              </a>
              <a href="https://researchmap.jp/ukyonagata" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
